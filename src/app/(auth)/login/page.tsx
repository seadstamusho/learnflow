    ...
    <div className="space-y-4">
      ...
      <button
        ...
        className="
          ...
          px-4 py-3 rounded-lg border border-zinc-200 dark:border-zinc-700
      ...
      <p className="text-xs text-center text-zinc-400 dark:text-zinc-500">
        ログインすると
        <a href="#" className="underline hover:text-zinc-600">プライバシーポリシー</a>
        に同意したことになります
      </p>
    </div>
  )
    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-zinc-950 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-zinc-200 dark:border-zinc-800 p-8 space-y-4">
          ...
          <Suspense fallback={<div className="h-14 bg-zinc-100 dark:bg-zinc-800 rounded animate-pulse" />}>
            <LoginForm />
          </Suspense>
        </div>
      </div>
